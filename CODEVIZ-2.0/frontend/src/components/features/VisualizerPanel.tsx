import { Eye, List, Search, Terminal } from 'lucide-react';
...
export const VisualizerPanel = () => {
    const { visualizationType, code, setCode, setVisualizationType, output } = useVisualization();
