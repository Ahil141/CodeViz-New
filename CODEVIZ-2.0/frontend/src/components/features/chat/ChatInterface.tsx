    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            id: 'welcome',
            role: 'assistant',
            content: 'Hello! I am your AI Code Tutor. Ask me anything about Data Structures and Algorithms!',
            timestamp: Date.now(),
        }
    ]);
            ...
            <div className="p-4 bg-white border-t border-gray-200">
                <div className="relative flex items-center">
                    <input
                        ...
                        className="w-full pl-4 pr-12 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all shadow-sm"
                        disabled={isLoading}
                    />
                    <button
                        onClick={handleSend}
